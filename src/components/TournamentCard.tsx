...
function TournamentCard({
  ...
  return (
    <Link href={`/tournament/${id}`} className="block">
      <div className="flex border rounded-lg shadow-lg p-3 bg-white w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-md hover:shadow-xl transition-shadow duration-300">
